...
export function MyTrialsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white rounded-3xl max-w-3xl w-full p-6 sm:p-7 shadow-2xl relative border border-slate-200 animate-in zoom-in-95 duration-200 max-h-[90vh] flex flex-col">
        {/* Close Button */}
        <button
          onClick={onClose}
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-1.5 flex items-center gap-2 flex-wrap">
                        ...
                        <span className="text-[11px] text-slate-500 font-medium">
                          Đã đặt lúc: <strong className="text-slate-800 font-bold">{bookingTimeStr}</strong> · Ngày {item.date || '04/09/2026'}
                        </span>
                      </div>
                    </div>
                  </div>
