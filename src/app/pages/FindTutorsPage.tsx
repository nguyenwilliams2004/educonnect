    ...
    <div className="bg-[#FAF9F6] min-h-screen py-8 md:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="space-y-2">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 text-blue-700 text-xs font-bold border border-blue-100 uppercase tracking-wider">
            <span className="w-1.5 h-1.5 rounded-full bg-blue-600" />
            Khu vực TP. Hà Nội & Toàn quốc
          </div>
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black text-slate-900 tracking-tight">
            Danh sách Giáo viên & Gia sư <span className="text-blue-600">đã kiểm định</span>
          </h1>
        ...
        {/* TOP FILTER BAR: MODERN BENTO ARCHITECTURE (Double-Bezel) */}
        <div className="p-1.5 sm:p-2 rounded-3xl bg-slate-900/[0.03] border border-slate-900/[0.06] shadow-sm">
          <div className="rounded-[calc(1.5rem-0.25rem)] bg-white p-4 sm:p-5 shadow-[inset_0_1px_1px_rgba(255,255,255,1)] space-y-4">
            ...
            <div className="flex flex-col md:flex-row items-center gap-2.5">
              <form onSubmit={handleSearchSubmit} className="relative flex-1 w-full">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-9 py-2.5 rounded-xl bg-slate-50/80 focus:bg-white border border-slate-200/80 focus:border-blue-500 text-xs sm:text-sm text-slate-900 outline-none transition-all placeholder:text-slate-400 font-medium"
                />
                {searchInput && (
                  <button
                    type="button"
              ...
              <div className="flex items-center gap-2 w-full md:w-auto shrink-0">
                <button
                  ...
                  className="w-full md:w-auto px-5 py-2.5 bg-blue-600 hover:bg-blue-700 active:scale-98 text-white font-bold rounded-xl text-xs transition-all cursor-pointer shadow-xs"
                >
                  Tìm kiếm
                </button>
                {activeFiltersCount > 0 && (
                  <button
                    ...
                    className="whitespace-nowrap px-4 py-2.5 bg-slate-100 hover:bg-slate-200 active:scale-98 text-slate-700 font-bold rounded-xl text-xs transition-all cursor-pointer"
                  >
            ...
            <div className="flex flex-wrap items-center gap-2 pt-2.5 border-t border-slate-100">
              ...
              <div className="relative group">
                <button
                  ...
                  className={`px-3.5 py-2 rounded-xl text-xs font-semibold border transition-all flex items-center gap-1.5 cursor-pointer select-none ${selectedSubjects.length > 0
                      ? 'border-blue-300 bg-blue-50 text-blue-900 shadow-2xs font-bold'
                ...
                <div className="invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-200 absolute left-0 top-full mt-2 w-80 sm:w-96 bg-white rounded-2xl p-4 shadow-[0_16px_36px_-8px_rgba(15,23,42,0.12)] border border-slate-200 z-50 max-h-96 overflow-y-auto space-y-3">
                        ...
                        {grp.items.map(sub => {
                          ...
                          return (
                            <button
                              ...
                              className={`px-2.5 py-1.5 rounded-lg text-left text-xs font-medium transition-colors flex items-center justify-between cursor-pointer ${isSelected ? 'bg-blue-600 text-white shadow-2xs font-bold' : 'bg-slate-50 hover:bg-slate-100 text-slate-700'
                                }`}
                            >
              ...
              <div className="relative group">
                <button
                  ...
                  className={`px-3.5 py-2 rounded-xl text-xs font-semibold border transition-all flex items-center gap-1.5 cursor-pointer select-none ${selectedLevels.length > 0
                      ? 'border-indigo-300 bg-indigo-50 text-indigo-900 shadow-2xs font-bold'
                      : 'border-slate-200 bg-white hover:bg-slate-50 text-slate-700'
                    }`}
                >
                ...
                <div className="invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-200 absolute left-0 top-full mt-2 w-64 bg-white rounded-2xl p-4 shadow-[0_16px_36px_-8px_rgba(15,23,42,0.12)] border border-slate-200 z-50 space-y-2">
                  <div className="text-xs font-bold text-slate-900 pb-2 border-b border-slate-100 flex justify-between items-center">
                    ...
                    {levelsList.map(lvl => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full px-3 py-2 rounded-lg text-left text-xs font-medium transition-colors flex items-center justify-between cursor-pointer ${isSelected ? 'bg-blue-600 text-white shadow-2xs font-bold' : 'bg-slate-50 hover:bg-slate-100 text-slate-700'
                            }`}
                        >
                          <span>{lvl}</span>
              ...
              <div className="relative group">
                ...
                <div className="invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-200 absolute left-0 top-full mt-2 w-72 bg-white rounded-2xl p-4 shadow-[0_16px_36px_-8px_rgba(15,23,42,0.12)] border border-slate-200 z-50 max-h-80 overflow-y-auto space-y-2">
                  <div className="text-xs font-bold text-slate-900 pb-2 border-b border-slate-100 flex justify-between items-center">
              ...
              <div className="relative group">
                <button
                  ...
                  className={`px-3.5 py-2 rounded-xl text-xs font-semibold border transition-all flex items-center gap-1.5 cursor-pointer select-none ${selectedTypes.length > 0
                      ? 'border-purple-300 bg-purple-50 text-purple-900 shadow-2xs font-bold'
                      : 'border-slate-200 bg-white hover:bg-slate-50 text-slate-700'
                    }`}
                >
                    ...
                    {typesList.map(t => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full px-3 py-2.5 rounded-lg text-left text-xs font-bold transition-all flex items-center justify-between cursor-pointer ${isSelected ? 'bg-blue-600 text-white shadow-2xs' : 'bg-slate-50 hover:bg-slate-100 text-slate-700'
                            }`}
                        >
                          <div>
                            <div>{t.label}</div>
                            <div className={`text-[10px] font-normal mt-0.5 ${isSelected ? 'text-blue-100' : 'text-slate-400'}`}>
              ...
              <div className="relative group">
                <button
                  ...
                  className={`px-3.5 py-2 rounded-xl text-xs font-semibold border transition-all flex items-center gap-1.5 cursor-pointer select-none ${selectedFormats.length > 0
                      ? 'border-amber-300 bg-amber-50 text-amber-900 shadow-2xs font-bold'
                      : 'border-slate-200 bg-white hover:bg-slate-50 text-slate-700'
                    }`}
                >
                ...
                <div className="invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-200 absolute left-0 top-full mt-2 w-60 bg-white rounded-2xl p-4 shadow-[0_16px_36px_-8px_rgba(15,23,42,0.12)] border border-slate-200 z-50 space-y-1.5">
            ...
            {activeFiltersCount > 0 && (
              <div className="flex flex-wrap items-center gap-1.5 pt-2 border-t border-slate-100">
                ...
                {selectedDistricts.map(dist => (
                  <span key={dist} className="inline-flex items-center gap-1 px-2.5 py-1 bg-emerald-50 text-emerald-800 border border-emerald-200 rounded-lg text-xs font-medium">
                    {dist}
        ...
        <main className="space-y-5">
          ...
          <div className="p-1 rounded-2xl bg-slate-900/[0.03] border border-slate-900/[0.06]">
            <div className="bg-white rounded-[calc(1rem-0.125rem)] p-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 shadow-[inset_0_1px_1px_rgba(255,255,255,1)]">
              <div className="text-xs sm:text-sm font-medium text-slate-600">
                Hiển thị <strong className="text-slate-900 font-black text-base tabular-nums">{filteredTutors.length}</strong> hồ sơ giáo viên & gia sư
              ...
              <div className="flex items-center gap-2 text-xs">
                ...
                <select
                  ...
                  className="px-3.5 py-1.5 rounded-xl bg-slate-50 border border-slate-200 text-xs font-bold text-slate-800 outline-none cursor-pointer hover:bg-slate-100 transition-colors"
                >
          ...
          {filteredTutors.length > 0 ? (
            <>
              ...
              {totalPages > 1 && (
                <div className="p-1 rounded-2xl bg-slate-900/[0.03] border border-slate-900/[0.06] mt-6">
                  <div className="bg-white rounded-[calc(1rem-0.125rem)] p-4 flex flex-col sm:flex-row justify-between items-center gap-4 shadow-[inset_0_1px_1px_rgba(255,255,255,1)]">
                    ...
                    <div className="flex items-center gap-1.5">
                      <button
                        ...
                        className="px-3.5 py-2 rounded-xl border border-slate-200 text-xs font-bold text-slate-700 hover:bg-slate-100 disabled:opacity-40 disabled:cursor-not-allowed transition-all inline-flex items-center gap-1 cursor-pointer"
                      >
            ...
            <div className="p-1 rounded-3xl bg-slate-900/[0.03] border border-slate-900/[0.06]">
              <div className="bg-white rounded-[calc(1.5rem-0.25rem)] p-12 text-center space-y-4 shadow-[inset_0_1px_1px_rgba(255,255,255,1)]">
                <div className="w-14 h-14 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center mx-auto shadow-2xs">
                  <Search className="w-6 h-6" />
                </div>
                <h3 className="text-base sm:text-lg font-black text-slate-900">Không tìm thấy hồ sơ giáo viên phù hợp</h3>
                ...
                <button
                  type="button"
                  onClick={resetFilters}
                  className="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 active:scale-98 text-white font-extrabold text-xs rounded-xl transition-all cursor-pointer shadow-sm"
                >
                  Xóa tất cả bộ lọc
                </button>
              </div>
