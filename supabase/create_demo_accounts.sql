...
DELETE FROM auth.identities WHERE provider_id IN ('giaovien.demo@gmail.com', 'hocsinh.demo@gmail.com');
DELETE FROM public.users WHERE email IN ('giaovien.demo@gmail.com', 'hocsinh.demo@gmail.com');
DELETE FROM auth.users WHERE email IN ('giaovien.demo@gmail.com', 'hocsinh.demo@gmail.com');
...
-- 4. ĐỒNG BỘ VÀO BẢNG PUBLIC.USERS
